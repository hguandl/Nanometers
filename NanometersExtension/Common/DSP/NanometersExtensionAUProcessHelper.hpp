//
//  NanometersExtensionAUProcessHelper.hpp
//  NanometersExtension
//
...
#include <vector>
#include "NanometersExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(NanometersExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    NanometersExtensionDSPKernel& mKernel;
