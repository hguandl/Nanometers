//
//  NanometersExtensionDSPKernel.hpp
//  NanometersExtension
//
...
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case NanometersExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in NanometersExtensionParameterAddresses.h
        }
    }
